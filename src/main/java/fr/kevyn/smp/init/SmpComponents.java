...
public class SmpComponents {
  ...
  public static final DeferredHolder<DataComponentType<?>, DataComponentType<OwnershipData>>
      OWNERSHIP = REGISTRY.registerComponentType("ownership", builder -> builder
